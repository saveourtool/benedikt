...
link:https://saveourtool.github.io/benedikt/docs/diktat-cli.adoc#exit-codes[exit
...
link:https://saveourtool.github.io/benedikt/docs/diktat-cli.adoc#exit-codes[here].
...
link:https://saveourtool.github.io/benedikt/docs/diktat-cli.adoc[command-line client].
